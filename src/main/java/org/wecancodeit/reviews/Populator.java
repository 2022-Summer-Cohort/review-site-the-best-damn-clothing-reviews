...
public class Populator implements CommandLineRunner {
    ...
    public void run(String...args) throws Exception{
        ...
        Review review2 = new Review("I use Shein often.", 4, shein);
        ...
        Review review7 = new Review("asdfasdfa", 4, dsw);
        ...
        Review review9 = new Review("DSW is the most valuable business resource we have EVER purchased.", 5, dsw);
        Review review10 = new Review("Kohls is the most valuable business resource we have EVER purchased. Absolutely wonderful! Since I invested in Kohls I made over 100,000 dollars profits.", 5, kohls);
        Review review11 = new Review("Kohls has got everything I need. I will let my mum know about this, she could really make use of Kohls!", 4, kohls);
        Review review12 = new Review("Keep up the excellent work. Thank you so much for your help. Not able to tell you how happy I am with Kohls.", 5, kohls);
        Review review13 = new Review("I didn't even need training. Fashion Nova is the most valuable business resource we have EVER purchased.", 5, fashionNova);
        Review review14 = new Review("Really good.", 5, fashionNova);
        Review review15 = new Review("This is simply unbelievable!", 5, fashionNova);
        Review review16 = new Review("Needless to say we are extremely satisfied with the results. Without Shoe Dazzle, we would have gone bankrupt by now. I could probably go into sales for you.", 4, shoeDazzle);
        Review review17 = new Review("The service was excellent. We've seen amazing results already.", 4, shoeDazzle);
        Review review18 = new Review("The very best. I will let my mum know about this, she could really make use of Shoe Dazzle! I would like to personally thank you for your outstanding product.", 5, shoeDazzle);
        Review review19 = new Review("Nike should be nominated for service of the year.", 5, nike);
